...
//
// The killer / countermove / history signals come from [History](history.hpp.md);
// continuation history arrives in a later step.
//
namespace engine {
